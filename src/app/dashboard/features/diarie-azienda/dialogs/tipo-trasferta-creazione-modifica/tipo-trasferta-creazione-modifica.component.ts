...
@Component({
  selector: 'app-tipo-trasferta-creazione-modifica',
  templateUrl: './tipo-trasferta-creazione-modifica.component.html',
  styleUrls: ['./tipo-trasferta-creazione-modifica.component.css']
})
export class TipoTrasfertaCreazioneModificaComponent {
